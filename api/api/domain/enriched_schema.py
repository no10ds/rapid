...
class EnrichedColumn(Column):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.partition_index == other.partition_index
...
class EnrichedSchema(Schema):
    ...
    def __eq__(self, other):
        ...
        base_equal = (
            ...
            and self.get_sensitivity() == other.get_sensitivity()
            and self.get_description() == other.get_description()
            and self.get_tags() == other.get_tags()
            and self.get_owners() == other.get_owners()
            and self.get_update_behaviour() == other.get_update_behaviour()
            and self.metadata.get("is_latest_version") == other.metadata.get("is_latest_version")
        )

        enriched_equal = (
            self.number_of_rows == other.number_of_rows
            and self.number_of_columns == other.number_of_columns
